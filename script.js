...
let crossScreen = document.querySelector(".cross-box")
let firstScreen = document.querySelector(".first-screen")
let numberThing = document.querySelector(".number-thing")
let basketHome = document.querySelector(".basket-home")
basketHome.addEventListener("click", function(){
    firstScreen.classList.add("full-screen")
    numberThing.classList.add("full-number")
    crossScreen.classList.add("full-cross")
})
let addCart = document.querySelector(".first-screen")
crossScreen.addEventListener("click", function(){
    firstScreen.classList.remove("full-screen")
    numberThing.classList.remove("full-number")
    crossScreen.classList.remove("full-cross")
})
...
function addToCart(productId){
    numberThing.innerHTML = productId
}
